  ...
  export default {
    ...
    methods: {
      initstadion (){
        ...
        this.departname = query.departname || '请选择';
        this.departid = query.departid || '请选择';
        this.reachname = query.reachname || '请选择';
        this.reachid = query.reachid || '请选择';
      }
    },
    components: { Tit,Choosestadion,swiper,swiperSlide }
  }
</script>
